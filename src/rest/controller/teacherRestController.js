...
var TeacherRestController = function(TeacherModel) {
     ...
     * http://localhost:9016/teachers            GET
     ...
     * 
       curl -i http://localhost:9016/teachers
     ...
     * http://localhost:9016/teachers/5a1464bf3322b34128b20c8c           GET
     * http://localhost:9016/api/v1/teachers/:id                         GET
     * 
       curl  http://localhost:9016/teachers/5a1464bf3322b34128b20c8c
       curl -i http://localhost:9016/teachers/5a1464bf3322b34128b20c8c
       curl -i -X GET http://localhost:9016/teachers/5a1464bf3322b34128b20c8c
     ...
     * http://localhost:9016/teachers             POST
     * 
       curl -X POST -H "Content-Type: application/json" -i -d  '{"teacherId": 0, "name":"ilker_0", "lastname":"kiris_0", "grade":"freshman ", "age":200, "isFullTime":false}' http://localhost:9016/teachers
       curl -X POST -H "Content-Type: application/json" -d     '{"teacherId": 1, "name":"ilker_1", "lastname":"kiris_1", "grade":"FreshMan",  "age":201, "isFullTime":false}' http://localhost:9016/teachers
       curl -X POST -H "Content-Type: application/json" --data '{"teacherId": 2, "name":"ilker_2", "lastname":"kiris_2", "grade":" freshman", "age":202, "isFullTime":true}'  http://localhost:9016/teachers
       curl -X POST -H "Content-Type: application/json" -i -d  '{"teacherId": 3, "name":"ilker_3", "lastname":"kiris_3", "grade":" freshman", "age":203, "isFullTime":true}'  http://localhost:9016/teachers
     * 
     ...
     * http://localhost:9016/teachers/:id             PATCH
     * 
       curl -X PATCH -H "Content-Type: application/json" -i -d '{"grade":"sophomore", "age":123, "isFullTime":false}' http://localhost:9016/teachers/5a23f72a1fb00a38f0a814a9
     * 
     * @param {*} req 
     * @param {*} res 
     */
     ...
     * http://localhost:9016/teachers/:id             DELETE
     * 
       curl -X DELETE -i http://localhost:9016/teachers/5a23f72a1fb00a38f0a814a9
     * 
     * @param {*} req 
     * @param {*} res 
     */
     ...
     * http://localhost:9016/teachers             DELETE
     * 
       curl -X DELETE -H "Content-Type: application/json" -i -d '{"_id":"5a2f1ef568f053451051ebdb"}' http://localhost:9016/teachers
     * 
     * @param {*} req 
     * @param {*} res 
     */
